...
const NewsLetter = () => {
  ...
  const handleNotify = () => {
    Swal.fire("Thank You! We will notify you!");
    setEmail("");
  };
  return (
    <section className="w-full  bg-gray-900">
      <hr />
      <div className="container relative flex flex-col  px-6 mx-auto py-40">
        <section className="flex items-center flex-1">
          <div className="flex flex-col w-full ">
            <h1 className="text-5xl font-extrabold text-center lg:text-7xl 2xl:text-8xl">
              ...
              <span className=" ml-2 text-transparent bg-gradient-to-tr bg-clip-text from-blue-500 via-pink-500 to-red-500 dark:from-sky-300 dark:via-pink-300 dark:to-red-500">
                Soon
              </span>
            </h1>

            <p className="max-w-3xl mx-auto mt-6 text-lg text-center text-white md:text-xl">
              Get ready to level up your game as we share tips and techniques to
              help you reach your full potential. Discover exclusive offers and
              promotions available only to our loyal newsletter subscribers.
            </p>
            ...
            <p className="mt-8 text-center text-white text-md md:text-xl">
              Notify me when new Course is launched :)
            </p>
          </div>
        </section>
      </div>
